...
use cranelift_wasm::{
    ...
    TranslationState, SignatureIndex, Table, TableIndex, WasmResult,
};

use super::func_env::FuncEnvironment;
use super::module::{Export, MemoryPlan, Module, TableElements, TablePlan};
...
pub struct ModuleTranslation<'data> {
    ...
    pub module_translation: Option<TranslationState>,
}
...
impl<'data> ModuleEnvironment<'data> {
    ...
    pub fn result(&self) -> &ModuleTranslation {
        &self.result
    }
}
